    ...
    <div class='right-top'>
      ...
      export default{
        ...
        methods:{
          init:function(){
            ...
            $.ajax({
              url:'http://cloud.tidicloud.com/cloud_code/GET/mapCount/sysMapCount.do',
              type:'GET',
              data:data,
              dataType:'json',
          ...
          error:function(res){
            ...
            $.ajax({
              url:'http://cloud.tidicloud.com/cloud_code/wdcouponorder/getAllOrderCount.do',
              type:'GET',
              success:function(res){
            ...
            $.ajax({
              url:'http://cloud.tidicloud.com/cloud_code/wdcouponorder/getDetailCount.do',
              type:'GET',
              success:function(res){
                self.shopList=res;
                self.hans(); 
            ...
            $.ajax({
              url:'http://cloud.tidicloud.com/cloud_code/GET/mapCount/getSystemScanCountByStartTimeAndEndTime.do',
              type:'GET',
              data:{
                userId:1
              },
      ...
      scans:function() {
        ...
        myChart.on('click', function (params) {
          ...
          var url='http://cloud.tidicloud.com/cloud_code/GET/mapCount/getSystemScanInfo.do';
          var type='get';
          var data={
            userId:1,
            sTime:infoDate
