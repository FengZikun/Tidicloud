	...
	<div class="right-main">
		...
		<div class="main">
			<div class="mengban" v-if='showMB' @click='showMB=false'>
				<img :src="'http://cloud.tidicloud.com'+big">
			</div>
			<div class="picBox">
				<span v-if='tradeMarkImgUrl===""||tradeMarkImgUrl===null' class="photo"></span>
				<img v-else class="checkPic" :src="'http://cloud.tidicloud.com'+tradeMarkImgUrl" @click='watch(tradeMarkImgUrl)'>
			...
			<div class="picBox">
				...
				<img v-else class="checkPic" :src="'http://cloud.tidicloud.com'+tradeMarkLicense" @click='watch(tradeMarkLicense)'>
			...
			<div class="picBox">
				...
				<img v-else class="checkPic" :src="'http://cloud.tidicloud.com'+industrialProductionLicense " @click='watch(industrialProductionLicense)'>
			...
			<div class="picBox">
				...
				<img v-else class="checkPic" :src="'http://cloud.tidicloud.com'+foodProductionLicence  " @click='watch(foodProductionLicence)'>
			...
			<div class="picBox">
				...
				<img v-else class="checkPic" :src="'http://cloud.tidicloud.com'+bankAccountOpeningLicense  " @click='watch(bankAccountOpeningLicense)'>
...
export default{
	...
	methods:{
		init(){
			var self=this;
			var url='http://cloud.tidicloud.com/cloud_code/POST/user/singleTestingUserInfo.do';
			var type='get';
			var data={
				userId:self.userId
			}
		...
		fail(){
			var self=this;
			var url='http://cloud.tidicloud.com/cloud_code/POST/user/unqualifiedPassingInfo.do';
			var type='post';
			var data={
				userId:self.userId,
		...
		commit(){
			var self=this;
			var url='http://cloud.tidicloud.com/cloud_code/POST/user/passCheckingUser.do';
			var type='get';
			var data={
				userId:self.userId
			}
