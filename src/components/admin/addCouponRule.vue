		...
		export default{
			...
			methods:{
				init:function(){
					var self=this;
				//黑名单
				var url='http://cloud.tidicloud.com/cloud_code/GET/couponRule/vendorOther.do';
				var type='get';
				var data={
			...
			getProInfo:function(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/couponRule/product.do';
				var type='get';
				var data={
					vendorId:self.vendorId
				};
			...
			getOrder:function(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/couponRule/order.do';
				var type='get';
				var data={
					vendorId:self.vendorId
				};
			...
			tijiao:function(){
				...
				var url='http://cloud.tidicloud.com/cloud_code/ADD/couponRule/info.do';
				var type='post';
				if(self.isScope==4){
