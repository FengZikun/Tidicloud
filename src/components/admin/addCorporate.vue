  ...
  <div>
    ...
    <form id='myform' class="message" enctype="multipart/form-data">
      ...
      <div class='message-box'>
        ...
        <div class="phbox">
          <img style="display:inline-block;width:86px;height:86px;vertical-align:top" v-for='item in imgSrcs' v-bind:src='"http://cloud.tidicloud.com"+item'></span>
  ...
  export default{
    ...
    methods:{
      ...
      upLoad1:function(){
        ...
        $.ajax({
          url: 'http://cloud.tidicloud.com/cloud_code/POST/vendor/uploadVendorBrandImg.do',
          type:'post',
          data: data,
          cache: false,
          dataType: 'json',
      ...
      confirm:function(){
        ...
        $.ajax({
          url: 'http://cloud.tidicloud.com/cloud_code/POST/vendor/addVendorInfo.do',
          type:'post',
          data: data,
          cache: false,
          dataType: 'json',
