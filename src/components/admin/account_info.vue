  ...
  export default{
    ...
    methods:{
      ...
      init:function(currentPage){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/GET/user/userInfoList.do';
        var type='get';
        var data={
          num:1,
          userId:1,
      ...
      resetPassword:function(){
        ...
        if(self.newPassword===self.checkPassword){
          var url='http://cloud.tidicloud.com/cloud_code/POST/user/updatePasswd.do';
          var type='post';
          var data={
            userId:userid,
      ...
      locking:function(){
        ...
        if(clickText.text()=='锁定账号'){
          var url='http://cloud.tidicloud.com/cloud_code/POST/user/lockUser.do';
          var type='post';
          var data={
        ...
        if(clickText.text()=='取消锁定'){
          var url='http://cloud.tidicloud.com/cloud_code/POST/user/canselLockUser.do';
          var type='post';
          var data={
            userId:parseInt(clickText.attr('data-id'))
          };
      ...
      addNew:function(){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/POST/user/vendorUser.do';
        var type='post';
        var data={
