	...
	methods:{
		...mapMutations({
			...
			nextStep:function(){
				...
				if(self.ymShop){
					$.ajax({
						url:'http://cloud.tidicloud.com/cloud_code/wqcoupon/getCouponPorudctUrl.do',
						type:'post',
				...
				if(self.jingdong){
					$.ajax({
						url:'http://cloud.tidicloud.com/cloud_code/GET/JDCoupon/isAccessTokenExpiresIn.do',
						type:'post',
						data:{vendorId:self.vendorId},
						datatype:'json',
						success:function(res){
			...
			confirm:function(){
				...
				var url='http://cloud.tidicloud.com/cloud_code/add/wd/coupon.do'
				var data={
			...
			// confirm2:function(){
			// 	var self=this;
			// 	var url='http://cloud.tidicloud.com/cloud_code/openweixin/getAuthByVendorId.do';
			// 	var type='get';
			// 	var data={
			// 		vendorId:self.vendorId,
			// 	};
			...
			// 				return
			// 			}
			// 			var url='http://cloud.tidicloud.com/cloud_code/weChatCoupon/create.do';
			// 			var type='get';
			// 			var data={
			// 				vendorId:self.vendorId,
			...
			jDconfirm:function(){
				...
				var url='http://cloud.tidicloud.com/cloud_code/ADD/JDCoupon/addJDCouponinfo.do'
				var data={
					vendorId:self.vendorId,
					jdUid:self.jdUid,
			...
			ymConfirm:function(){
				...
				$.ajax({
					url:'http://cloud.tidicloud.com/cloud_code/wqcoupon/addcoupon.do',
					type:'post',
					data:{
						vendorId:self.vendorId,
