	...
	<div class="right-main">
		<div class="main">
			...
			<div class='message-box'>
				...
				<div class="phbox">
					<img v-if='imgSrcA!=null' class="photo1" v-bind:src="'http://cloud.tidicloud.com'+imgSrcA"></img>
					<span v-else class='photo' v-bind:style="{backgroundImage: imgSrcA}"></span>
					<p class="p">客户资质证书</p>
				</div>
				<div class="phbox">
					<img v-if='imgSrcB!=null' class="photo1" v-bind:src="'http://cloud.tidicloud.com'+imgSrcB"></img>
					<span v-else class='photo'  v-bind:style="{backgroundImage: imgSrcB}"></span>
					<p class="p">商标注册证</p>
				</div>
				<div class="phbox">
					<img v-if='imgSrcC!=null' class="photo1" v-bind:src="'http://cloud.tidicloud.com'+imgSrcC"></img>
					<span v-else class='photo'  v-bind:style="{backgroundImage: imgSrcC}"></span>
					<p class="p">工业产品生产许可证</p>
				</div>
				<div class="phbox">
					<img v-if='imgSrcD!=null' class="photo1" v-bind:src="'http://cloud.tidicloud.com'+imgSrcD"></img>
					<span v-else class='photo'  v-bind:style="{backgroundImage: imgSrcD}"></span>
					<p class="p">食品生产许可证</p>
				</div>
				<div class="phbox">
					<img v-if='imgSrcE!=null' class="photo1" v-bind:src="'http://cloud.tidicloud.com'+imgSrcE"></img>
			...
			<!-- <div class="messagebox">
				...
				<div class="phbox" v-for='item in imgInfo'>
					<img class="photo1" v-bind:src="'http://cloud.tidicloud.com'+item.imgUrl"></img>
				</div>
			</div> -->
		</div>
	</div>
...
<script>
	...
	export default{
		...
		methods:{
			init:function(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/vendor/getVendorInfo.do';
				var type='get';
				var data={
			...
			// init2:function(){
			// 	var self=this;
			// 	var url='http://cloud.tidicloud.com/cloud_code/GET/vendor/getVendorBrandImg.do';
			// 	var type='get';
			// 	var data={
			// 		id:self.detailId
			// 	};
