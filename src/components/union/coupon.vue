	...
	<script>
		...
		methods:{
			...
			init:function(currentPage){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/wdCoupon/couponInfoList.do';
				var type='get';
				var data={
		        ...
		        $.ajax({
		        	url:'http://cloud.tidicloud.com/cloud_code/GET/JDCoupon/getJDCouponList.do',
		        	type:'post',
		        ...
		        $.ajax({
		        	url:'http://cloud.tidicloud.com/cloud_code/wqcoupon/getcoupon.do',
		        	type:'post',
		        	data:{vendorId:self.vendorId},
		        	dataType:'json',
		        	success:function(res){
	      ...
	      mengban3:function(){
			...
			search:function(){
				var self=this;
				self.showMB=true;
				var url='http://cloud.tidicloud.com/cloud_code/GET/wd/config.do';
				var type='get';
				var data={
					vendorId:self.vendorId
				};
			...
			wxdbind:function(){
				var self=this;
				$.ajax({
					url:'http://cloud.tidicloud.com/cloud_code/wechatCouponConfig/getConfig.do',
					type:'post',
					data:{
						vendorId:self.vendorId,
					},
			...
			connect:function(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/ADD/wd/config.do';
				var type='post';
				var data={
					vendorId:self.vendorId,
					appKey:self.appKey,
			...
			connectwxd:function(){
        		...
        		$.ajax({
		          url: 'http://cloud.tidicloud.com/cloud_code/wechatCouponConfig/addConfig.do',
		          type:'post',
		          data: data,
		          cache: false,
		          dataType: 'json',
			...
			updatewxd:function(){
				...
				var data=new FormData($('#wxd')[0]);
        		$.ajax({
		          url: 'http://cloud.tidicloud.com/cloud_code//wechatCouponConfig/updateConfig.do',
		          type:'post',
		          data: data,
		          cache: false,
		          dataType: 'json',
			...
			jdbind:function(){
				var self=this;
				window.location.href=`https://auth.360buy.com/oauth/authorize?response_type=code&client_id=10BA26253A1DC058653DB0EC06069639&redirect_uri=http://cloud.tidicloud.com/cloud_code/GET/JDCoupon/getAccessTokenByCode.do&state=${self.vendorId}`;
			},
			//隐藏蒙版
			hide:function(){
				this.showMB=false;
			...
			delcoupon:function(){
				var self=this;
				self.showMB3=false;
				var url='http://cloud.tidicloud.com/cloud_code/DELETE/coupon/info.do';
				var type='get';
				var data={
					vendorId:self.vendorId,
			...
			changeTime(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/GetUrlForUpdateWdAccessToken';
				var type = 'get';
				var data = {
					vendorId:self.vendorId
				}
