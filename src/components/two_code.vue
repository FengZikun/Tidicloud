  ...
  <div>
    ...
    <el-row>
      <el-col :span="3">
        <div class='goods_left'>
          ...
          <el-menu-item index="1" :route="{path: '/twoCode/gaikuang'}">
            <i class="el-icon-location"></i>
            <span slot="title">扫码概况</span>
          </el-menu-item>
          <el-submenu index="2">
            <template slot="title">
            ...
            <el-menu-item index="2-1" :route="{path: '/twoCode/enterprise_order'}">
              防伪码生成
            </el-menu-item>
            <el-menu-item index="2-2" :route="{path: '/twoCode/briefCode'}">
              防伪页模板
            </el-menu-item>
            <el-menu-item index="2-3" :route="{path: '/twoCode/activity'}">
              扫码活动管理
            </el-menu-item>
            <el-menu-item index="2-4" :route="{path: '/twoCode/scan'}">
              扫码明细
            </el-menu-item>
          </el-submenu>
          <el-submenu index="3">
            ...
            <el-menu-item index="3-1" :route="{path: '/twoCode/sourceCode'}">
              溯源码生成
            </el-menu-item>
            <el-menu-item index="3-2" :route="{path: '/twoCode/briefCodeSu'}">
              溯源页模板
            </el-menu-item>
            <el-menu-item index="3-3" :route="{path: '/twoCode/activitySu'}">
              扫码活动管理
            </el-menu-item>
            <el-menu-item index="3-4" :route="{path: '/twoCode/channel'}">
              渠道管理
            </el-menu-item>
            <el-menu-item index="3-5" :route="{path: '/twoCode/analysis'}">
              渠道信息分析
            </el-menu-item>
            <el-menu-item index="3-6" :route="{path: '/twoCode/scanSu'}">
              扫码明细
            </el-menu-item>
            <el-menu-item index="3-7" :route="{path: '/twoCode/suggestion'}">
              用户意见
            </el-menu-item>
          </el-submenu>
          <el-submenu index="4">
            ...
            <el-menu-item index="4-1" :route="{path: '/twoCode/hongbao'}">
              发放红包
            </el-menu-item>
            <el-menu-item index="4-2" :route="{path: '/twoCode/game'}">
              集字游戏
            </el-menu-item>
          </el-submenu>
        </el-menu>
    ...
    <script>
      ...
      getApp:function(){
        var self=this;
        $.ajax({
          url:'http://cloud.tidicloud.com/cloud_code/GET/wqapp/getAllAppInfo.do',
          type:'get',
