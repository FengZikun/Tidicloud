    ...
    <div class="step2" v-bind:class='{hidestep:twohide}'>
    	...
    	<div class="main">
    		...
    		<div class="promessage">
    			...
    			<img v-for='img in selectimg' class="myimg" style="width:86px;height:86px;vertical-align:top;" v-bind:src="'http://cloud.tidicloud.com'+img">
	...
	data(){
		...
		methods:{
			...
			init:function(){
				...
				//修改
				if(self.productid!=''){
					var url='http://cloud.tidicloud.com/cloud_code/GET/product/presentById.do';
					var type='post';
					var data={
						id:self.productid
					};
				...
				//进入新增页面后请求分类信息
				var url='http://cloud.tidicloud.com/cloud_code/GET/product/presentGroup.do';
				var type='get';
				var data={
			...
			complete:function(){
				...
				//修改
				if(self.productid!=''){
					var url='http://cloud.tidicloud.com/cloud_code/UPDATE/product/present.do';
					var type='post';
					var data={
						id:self.productid,
						rowId:self.rowId,
				...
				var url='http://cloud.tidicloud.com/cloud_code/ADD/product/present.do';
				var type='post';
				var data={
					vendorId:self.vendorId,
					rowId:self.rowId,
