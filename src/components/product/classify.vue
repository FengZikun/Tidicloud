  ...
  export default{
    ...
    methods:{
      ...
      addclassify:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/ADD/product/group.do';
        var type='post';
        var data={
          vendorId:self.vendorId,
          name:self.name,
      ...
      delclassify:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/product/group.do';
        var type='post';
        var data={
          id:id
        };
      ...
      reviseclassify:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/UPDATE/product/group.do';
        var type='post';
