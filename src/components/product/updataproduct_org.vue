	...
	<div class="right-main">
		...
		<div class="step2" v-bind:class='{hidestep:twohide}'>
					...
					<div class="imgmain" v-if='local'>
						<ul @click.prevent='chooseimg' style="height:450px;">
							<li class="single-img" v-for='item in imglist'>
								<img v-bind:src="'http://cloud.tidicloud.com'+item.imgUrl" class="proimg" style="width:110px;height:110px" v-bind:data-id='item.id'>
			...
			<div class="main">
				...
				<div class="promessage">
					<span class="message-name star">产品图片：</span>
					<img v-for='img in selectimg' class="myimg" style="width:86px;height:86px;vertical-align:top;" v-bind:src="'http://cloud.tidicloud.com'+img" v-if='productid==""'>
					<img class="myimg" style="width:86px;height:64px;vertical-align:top;" v-bind:src="'http://cloud.tidicloud.com'+productImg" @click='delImg' v-if='productid!=""'>
...
<script>
	...
	Vue.use(VueHtml5Editor, {
		...
		image: {
			...
			quality: 80,
      // upload: {
      //       url: 'http://cloud.tidicloud.com/imageContent/',
      //       headers: {},
      //       params: {},
      //       fieldName: {}
      //   },
	...
	export default{
		...
		methods:{
			...
			init:function(){
				...
				//修改
				if(self.productid!=''){
					var url='http://cloud.tidicloud.com/cloud_code/GET/product/infoById.do';
					var type='post';
					var data={
		...
		showStep1:function(){
			...
			chooseClassify:function(){
				var self=this;
				self.showMB=true;
				var url='http://cloud.tidicloud.com/cloud_code/GET/product/group.do';
				var type='get';
				var data={
			...
			complete:function(){
				...
				//修改
				if(self.productid!=''){
					var url='http://cloud.tidicloud.com/cloud_code/UPDATE/product/info.do';
					var type='post';
				...
				//增加
				var url='http://cloud.tidicloud.com/cloud_code/ADD/product/info.do';
				var type='post';
				var data={
					vendorId:self.vendorId,
					rowId:self.rowId,
			...
			searchphoto:function(num){
				var self=this;
				self.showMBimg=true;
				var url='http://cloud.tidicloud.com/cloud_code/GET/product/Image.do';
				var type='get';
				var data={
					currentPage:num,
					pageSize:12,
			...
			confirm:function(){
				...
				$('.myimg').attr('src',"http://cloud.tidicloud.com"+self.selectimg)
				self.hide();
			},
			//上传图片
			upLoad1:function(){
				...
				$.ajax({
					url: 'http://cloud.tidicloud.com/cloud_code/ADD/product/uploadImage.do',
					type:'post',
					data: data,
					cache: false,
					dataType: 'json',
			...
			delImg:function(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/DELETE/product/Image.do';
				var type='post';
				var data={
					id:$(event.target).attr('data-id')
				};
			...
			addparameter:function(){
				...
				var url='http://cloud.tidicloud.com/cloud_code/ADD/product/param.do';
				var type='post';
			...
			delparams:function(index){
				...
				var url='http://cloud.tidicloud.com/cloud_code/DELETE/product/param.do';
				var type='post';
				var data={
					paramId:id
				};
