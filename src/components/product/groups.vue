  ...
  export default{
    ...
    methods:{
      ...
      getData:function(){
        ...
        $.ajax({
          type:'get',
          url:'http://cloud.tidicloud.com/cloud_code/GET/product/presentGroup.do',
          dataType:'json',
          data:{
      ...
      addclassify:function(){
        ...
        if(self.zengjia){
          var url='http://cloud.tidicloud.com/cloud_code/ADD/product/presentGroup.do';
          var data={
              vendorId:self.vendorId,
              name:self.name
            };
        }else{
          var url='http://cloud.tidicloud.com/cloud_code/UPDATE/product/presentGroup.do';
          var data={
              id:self.id,
              name:self.name
            };
      ...
      delclassify:function(){
        var self=this;
        self.id=$(event.target).attr('data-id');
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/product/presentGroup.do';
        var type='post';
        var data={
          id:self.id
        };
