              ...
              <div class="my-form">
                <ul class="pro-list">
                  ...
                  <li class="pro-li" v-for='gift in gifts'>
                    <span class="pro-li-span first" v-bind:data-id='gift.id'><span class="check-box checkshu" @click='selectThis' style="margin-left:10%;margin-right:5%;"></span><span style="display: inline-block;vertical-align: middle;overflow: hidden"><img style="width:45px;margin-left:20px;" v-bind:src="'http://cloud.tidicloud.com'+gift.presentImg">{{gift.presentName}}</span></span>
  ...
  export default{
    ...
    methods:{
      ...
      deleteGift:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/product/present.do';
        var type='post';
        var data={
            id:deletedata
          };
      ...
      huanyuan:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/product/batchPresent.do';
        var type='post';
        var data={
            id:huanyuandata,
            deleteFlag:0
