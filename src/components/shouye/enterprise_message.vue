  ...
  <div>
    ...
    methods:{
      init:function(currentPage){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/GET/vendor/basicInfo.do';
        var type='get';
        var data={
        ...
        var success=function(res){
            ...
            self.imgUrl=`url(http://cloud.tidicloud.com${res.imgUrl})`;
      ...
      complete:function(){
        ...
        $.ajax({
          url: 'http://cloud.tidicloud.com/cloud_code/ADD/vendor/basicInfo.do',
          type:'post',
          data: data,
          cache: false,
          dataType: 'json',
      ...
      complete1:function(){
        ...
        $.ajax({
          url: 'http://cloud.tidicloud.com/cloud_code/UPDATE/vendor/basicInfo.do',
          type:'post',
          data: data,
          cache: false,
          dataType: 'json',
