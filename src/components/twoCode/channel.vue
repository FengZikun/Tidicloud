  ...
  export default{
    ...
    methods:{
     init:function(currentPage){
      var self=this;
      var url2='http://cloud.tidicloud.com/cloud_code/GET/agent/getAllAgent.do'
      var type='get';
      var data={
      ...
      .size([height, width - 160]);
        ...
        d3.json("http://cloud.tidicloud.com/cloud_code/GET/agent/getAgentTree.do?vendorId="+self.datas.vendorId, function(error, data) {
      ...
      selectTree:function(){
        ...
        if($(event.target)[0].nodeName==='text'){
          ...
          var url='http://cloud.tidicloud.com/cloud_code/GET/agent/getAgentInfoByNodeId.do';
          var type='get';
          var data={
            vendorId:self.datas.vendorId,
            id:id
      ...
      confirm:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/ADD/agent/addAgentInfo.do';
        var type='post';
        var data={
          vendorId:self.datas.vendorId,
      ...
      shouquan:function(){
        ...
        if($(event.target)[0].innerText==='授权码'){
          ...
          var url='http://cloud.tidicloud.com/cloud_code/ADD/agent/vendorGenerateLogisticCode.do';
          var type='get';
          var data={
            agentId:agentId,
      ...
      delAgent(){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/agent/deleteAgentNode.do';
          var type='get';
          var data={
      ...
      showMa:function(id){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/GET/agent/getAgentLogisticCode.do';
        var type='get';
        var data={
          agentId:id
        };
      ...
      newCode:function(code){
        var self=this;
        self.showCode=true;
        var code="http://cloud.tidicloud.com/cloud_code/w/"+code;
      ...
      delet(id){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/AgentEmployee/deleteAgentEmp.do';
        var type='get';
        var data={
          empId:id
        };
      ...
      detail(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/GET/AgentEmployee/getEmpInfoById.do';
        var type='get';
        var data={
          agentId:agentId
        };
