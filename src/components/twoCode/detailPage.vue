...
<!--     <div class="modelBg">
      <div class="modelContent">
        <iframe src="http://cloud.tidicloud.com/cloud_code/wx/1/red.html" width="349px" height="663px"></iframe>
      ...
      export default{
        ...
        methods: {
          ...
          savemod(){
            ...
            $.ajax({
              url: 'http://cloud.tidicloud.com/cloud_code/SAVE/codeManager/saveFileFunType.do',
              data: {
                html:str
              },
              type: 'POST',
          ...
          tobaba(){
            ...
            <script src="https://res.wx.qq.com/open/js/jweixin-1.0.0.js">`+"</scr" + "ipt>"+`
              <script src="js/zepto_1.2.0.min.js" type="text/javascript" charset="utf-8">`+"</scr" + "ipt>"+`
                <script type="text/javascript">
                  (function () {
                    var _937 = {
                      ...
                      jumpTo: function (id) {
                        ...
                        if (id === 'btn3') {
                          setTimeout(function () {
                            window.location.href = 'https://weidian.com/?userid=1154972666'
                          }, 500)
                          return
                        }
                        if (id === 'btn4') {
                          setTimeout(function () {
                            window.location.href = 'https://efun.com.cn/'
                          }, 500)
                          return
                        }
                        if (id === 'btn5') {
                  ...
                  $.ajax({
                    url: 'http://cloud.tidicloud.com/cloud_code/POST/antiFake/html.do',
                    data: {
