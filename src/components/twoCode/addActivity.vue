	...
	export default{
        ...
        methods:{
			...
			init1:function(){
				...
				var url='http://cloud.tidicloud.com/cloud_code/GET/codeManager/getScaPageModel.do';
				var type='get';
				var data={
				...
				var success=function(res){
					...
					if(self.datas.activityId!=null){
						var url='http://cloud.tidicloud.com/cloud_code/GET/codeManager/getCodeManagerById.do';
						var type='get';
						var data={
			...
			init:function(currentPage){
				...
				self.showMB=true;
				if(self.type==1){
					var url='http://cloud.tidicloud.com/cloud_code/GET/codeManager/productInfoList.do';
				}
				else if(self.type==0){
					var url="http://cloud.tidicloud.com/cloud_code/GET/codeManager/getProductOrderTracyInfo.do";
				}
				// var url='http://cloud.tidicloud.com/cloud_code/GET/codeManager/productInfoList.do';
				// var url="http://cloud.tidicloud.com/cloud_code/GET/codeManager/getCodeManagerAllForTracy.do";
				var type='get';
				var data={
					vendorId:self.datas.vendorId,
			...
			showKuang(event,name){
				...
				if(name==="modelS"){
					...
					var url='http://cloud.tidicloud.com/cloud_code/POST/antiFake/htmlStoreDate.do'
					var data={
						actionId:id
					}
					var type='post';
					var success=function(res){
						...
						if(res.storeData===null){
							...
							self.frameSrc='http://cloud.tidicloud.com/wx/'+$(event.target).attr('data-url');
			...
			submit:function(){
				...
				if(self.datas.activityId!=null){
					...
					var url='http://cloud.tidicloud.com/cloud_code/UPDATE/codeManager/updateCodeManager.do';
				}else{
					var data={
						orderId:self.orderId,
						vendor_id:self.datas.vendorId,
					...
					var url='http://cloud.tidicloud.com/cloud_code/ADD/codeManager/addCodeManager.do';
				}
				var type='post';
				var success=function(res){
					if(res.status===1){
