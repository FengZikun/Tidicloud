  ...
  <div>
    ...
    <div class="right-main">
      <div class="right-main-bottom">
        ...
        <Table :data="proInfo" :header="getHeader()">
  ...
  data(){
    ...
    methods:{
      ...
      init:function(currentPage){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/GET/product/productInfoList.do';
        var type='get';
        var data={
      ...
      deletOrder:function(){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/product/productOrder.do';
        var type='post';
        var data={
      ...
      two:function(){
        ...
        var self=this;
        var id=$(event.target).attr('data-id');
        var url='http://cloud.tidicloud.com/cloud_code/POST/securityCode/createSecurityCode.do';
        var type='post';
      ...
      confirmDownLoad:function(){
        ...
        var id=$(event.target).attr('data-id');
        $.ajax({
          url:'http://cloud.tidicloud.com/cloud_code/GET/securityCode/securityCodeExportCountWarn.do',
          type:'post',
          data:{orderId:id},
          datatype:'json',
      ...
      downLoad:function(id){
        var downloadURL = "http://cloud.tidicloud.com/cloud_code/POST/securityCode/exportVendorSecurityCode.do";  
