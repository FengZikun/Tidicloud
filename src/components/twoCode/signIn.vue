...
export default{
	data(){
		...
		methods:{
			...
			delThis(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/vendorIntegral/deleteVendorIntegral.do';
				var type='get';
				var data={
					vendorId:self.datas.vendorId,
			...
			changeState(id){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/vendorIntegral/updateRuleStatus.do';
				var type='get';
				var data={
					vendorId:self.datas.vendorId,
					inteRuleId:id
