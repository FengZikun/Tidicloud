			...
			<div class="choosepro" >
				...
				<ul class="choosepro-main" v-show='product'>
					...
					<li class="pro-li" v-for='(item,index) in info'>
						...
						<span class="pro-li-span" style="text-align:left;"><img style="width:45px;margin-left:20px;" v-bind:src="'http://cloud.tidicloud.com/'+item.productImg">{{item.productName}}</span>
	...
	export default{
		...
		methods:{
			start(){
				var self=this;
				if(this.ruleId){
					var url='http://cloud.tidicloud.com/cloud_code/GET/vendorIntegral/findRuleByInteRuleId.do';
					var type='get';
					var data={
			...
			init:function(currentPage){
				...
				self.product=false;
				self.rule=false;
				var url='http://cloud.tidicloud.com/cloud_code/GET/CollectWord/getCollectWordOrder.do';
				var type='get';
				var data={
					vendorId:self.datas.vendorId,
		    ...
		    choosePro:function(currentPage){
		    	...
		    	self.order=false;
		    	self.rule=false;
		    	var url='http://cloud.tidicloud.com/cloud_code/GET/CollectWord/getProductForCollectWord.do';
		    	var type='get';
		    	var data={
		    ...
		    complete(){
		    	...
		    	if(self.ruleId){
		    		var url='http://cloud.tidicloud.com/cloud_code/GET/vendorIntegral/updateVendorIntegralRule.do';
		    		var type='post';
		    		var data={
		    	...
		    	var url='http://cloud.tidicloud.com/cloud_code/GET/vendorIntegral/CreateVendorIntegralRule.do';
		    	var type='post';
		    	var data={
		    		ruleName:self.ruleName,
		    		vendorId:self.datas.vendorId,
