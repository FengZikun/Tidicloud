		...
		return{
       	...
       	methods:{
			...
			showStep2:function(){
				...
				var url='http://cloud.tidicloud.com/cloud_code/GET/redEnv/moneyScope.do';
				var type='get';
				var data={
			...
			showStep3:function(){
				...
				var url='http://cloud.tidicloud.com/cloud_code/ADD/redEnv/info.do';
				var type='post';
				var data={
			...
			init:function(currentPage){
				...
				self.showMB=true;
				self.order=true;
				var url='http://cloud.tidicloud.com/cloud_code/GET/product/productEnvInfoList.do';
				var type='get';
				var data={
			...
			chooseRule:function(currentPage){
				...
				self.showMB=true;
				self.rule=true;
				var url='http://cloud.tidicloud.com/cloud_code/GET/redEnv/ruleInfo.do';
				var type='get';
				var data={
					vendorId:parseInt(self.datas.vendorId),
					currentPage:currentPage,
