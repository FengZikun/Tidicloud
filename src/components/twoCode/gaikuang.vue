  ...
  export default{
    ...
    methods:{
      init:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/GET/mapCount/mapSecurityCount.do';
        var type='get';
        var data={
        ...
        $.ajax({
          url:'http://cloud.tidicloud.com/cloud_code/GET/mapCount/vendorWeekMapCount.do',
          type:'post',
          data:{
            userId:self.datas.userId,
            vendorId:self.datas.vendorId
        ...
        $.ajax({
          url:'http://cloud.tidicloud.com/cloud_code/GET/mapCount/count.do',
          type:'post',
          data:{
            vendorId:self.datas.vendorId
          },
      ...
      maph:function () {
        ...
        chart.on('click',function(params){
          ...
          if(params.seriesName=='中国'){
            ...
            var url='http://cloud.tidicloud.com/cloud_code/GET/agent/getCityData.do';
            var type='post';
            var data={
              NameOrCode:code
            }
            var success=function(datas){
              ...
              //请求城市扫码量
              var url='http://cloud.tidicloud.com/cloud_code/GET/mapCount/mapCountForCity.do';
              var type='post';
              var data={
                vendorId:self.datas.vendorId,
                province:thisName+'省'
          ...
          if(params.seriesName.match('省')=='省'){
            ...
            var url='http://cloud.tidicloud.com/cloud_code/GET/agent/getMainCityData.do';
            var type='post';
            var data={
              code:code
            }
            var success=function(datas){
              //请求区扫码量
              var url="http://cloud.tidicloud.com/cloud_code/GET/mapCount/getDistrCount.do"
              var type="post";
              var data={
                vendorId:self.datas.vendorId,
                city:thisName
          ...
          if(params.seriesName=='市'){
            ...
            var url='http://cloud.tidicloud.com/cloud_code/GET/mapCount/heatMapForDistr.do';
            var type='post';
            var data={
              vendorId:self.datas.vendorId,
              district:thisName
