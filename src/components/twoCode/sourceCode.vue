    ...
    methods:{
      ...
      source:function(){
        ...
        // if(parseInt(self.proNum)<=parseInt(self.proCount)){
          ...
          var url='http://cloud.tidicloud.com/cloud_code/POST/productTracing/createProductTracingCode.do';
          var type='post';
          var data={
      ...
      downLoad1:function(){
        var id=$(event.target).attr('data-id');
        var downloadURL = "http://cloud.tidicloud.com/cloud_code//POST/securityCode/exportProductTracingCode.do";  
        ...
        defined:function(){
          ...
          $.ajax({
            url:'http://cloud.tidicloud.com/cloud_code/GET/productTracingGroupcode/upperTracingDegree.do',
            type:'POST',
            data:{
              orderId:orderId
            },
