	...
	export default{
		data(){
		    ...
		    chooseRule:function(){
		    	...
		    	self.order=false;
		    	self.rule=true;
		    	var url='http://cloud.tidicloud.com/cloud_code/GET/CollectWord/getRuleList.do';
		    	var type='get';
		    	var data={
		    		vendorId:parseInt(self.datas.vendorId),
		    	};
			...
			complete(){
		    	...
		    	var url='http://cloud.tidicloud.com/cloud_code/ADD/CollectWord/addCollectWordGame.do';
		    	var type='post';
		    	var data={
