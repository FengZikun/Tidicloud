	...
	export default{
		...
		methods:{
			...
			init(){
				var self=this;
				if(self.ruleId!==null){
					var url='http://cloud.tidicloud.com/cloud_code/GET/CollectWord/getRuleInfoById.do';
					var type='get';
					var data={
						id:self.ruleId
					};
			...
			add(){
				var self=this;
				var url="http://cloud.tidicloud.com/cloud_code/ADD/CollectWord/addCollectWordRule.do";
					var type='post';
