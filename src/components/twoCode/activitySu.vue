  ...
  export default{
    ...
    methods:{
      ...
      delactivity:function(){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/DELETE/codeManager/deleteCodeManager.do';
        var type='post';
        var data={
          id:self.delinfo
        };
      ...
      getOrderInfo:function(){
        ...
        var url='http://cloud.tidicloud.com/cloud_code/GET/product/productOrderInfo.do';
        var type='get';
        var data={
          orderId:id
        };
      ...
      changeStatus:function(status,id){
        var self=this;
        var url='http://cloud.tidicloud.com/cloud_code/UPDATE/codeManager/updateScaPageStatus.do';
        var type='post';
        var data={
          id:parseInt(id),
      ...
      // 预览
      showKuang(event){
        this.frameSrc='http://cloud.tidicloud.com/wx/'+$(event.target).attr('data-url');
