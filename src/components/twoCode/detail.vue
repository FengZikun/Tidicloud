	...
	export default{
        ...
        methods:{
			...
			init:function(currentPage){
				...
				if(self.type==1){
					self.url='http://cloud.tidicloud.com/cloud_code/GET/securityCode/securityCodeList.do';
				}
				else if(self.type==0){
					switch (self.packType) {
						case 'block':
							self.url='http://cloud.tidicloud.com/cloud_code/GET/productTracingcode/tracingCodeList.do';
							break;
						case 'row':
							self.url='http://cloud.tidicloud.com/cloud_code/GET/productTracingGroupcode/tracingCodeList.do';
						break;
						case 'box':
							self.url='http://cloud.tidicloud.com/cloud_code/GET/productTracingBoxcode/tracingCodeList.do';
						break;
					}
			...
			newCode:function(){
				...
				if(self.type==1){
					var code="http://cloud.tidicloud.com/cloud_code/s/"+code;
				}
				else if(self.type==0){
					var code="http://cloud.tidicloud.com/cloud_code/t/"+code;
				}
