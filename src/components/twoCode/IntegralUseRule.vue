...
<script type="text/javascript">
	...
	export default{
		...
		methods:{
			...
			init(currentPage){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/vendorIntegral/vendorIntegralExchangesHistoryList.do';
				var type='get';
				var data={
			...
			delThis(){
				var self=this;
				var url='http://cloud.tidicloud.com/cloud_code/GET/vendorIntegral/deleteExchangesInfo.do';
				var type='get';
				var data={
					vendorId:self.datas.vendorId,
