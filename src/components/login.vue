  ...
  export default{
    ...
    methods:{
      ...
      changecapcha:function(){
        $(".cap").attr("src", "http://cloud.tidicloud.com/cloud_code/GET/user/captcha.do?timestamp=" + (new Date()).valueOf());
      },
      login:function(){
        var self=this;
        ...
        if(errormsg){
          ...
          self.loading();
          var url='http://cloud.tidicloud.com/cloud_code/POST/user/login.do';
          var type='post';
